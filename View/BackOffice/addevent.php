...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($organizer_id)) {
        $errors[] = "L'identifiant de l'organisateur est requis.";
    } elseif (!is_numeric($organizer_id)) {
        $errors[] = "L'identifiant de l'organisateur doit être un nombre.";
    }

    // If no errors, proceed to add event
    if (empty($errors)) {
        $event = new event();
        ...
        echo "<div class='alert alert-danger m-3'><ul>";
