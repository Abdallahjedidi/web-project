                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="utilisateur_nom"
                                name="utilisateur_nom" placeholder="Nom de l'utilisateur" >
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control form-control-user" id="date_signalement"
                        ...
                        <div class="form-group">
                            <textarea class="form-control form-control-user" id="description"
                                name="description" placeholder="Description du problème" ></textarea>
                        </div>
                        <div class="form-group">
