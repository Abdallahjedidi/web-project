        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="price.html">evenment</a>
              </li>
              <li class="nav-item">
...
<div class="container">
  <div class="row">
    ...
    <input type="hidden" name="id_espace" value="<?= $espace['id'] ?>">
    <input type="submit" class="btn btn-secondary w-100 mt-2" value="Voir les activités">
</form>
